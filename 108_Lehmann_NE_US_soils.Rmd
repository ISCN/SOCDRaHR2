...
The NAME HERE data set in ISCN3 contains XX layer-level rows and YY profile-level information rows after cleaning for ISCN3.5.
...
datasetName <- "Lehmann NE US soils" #fix this
...
X Set country to United States
- Remove layer_note column?
