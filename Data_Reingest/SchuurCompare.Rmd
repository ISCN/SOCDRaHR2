...
The data reingest function for the Schuur dataset is not yet possible due to a stale URL. Use this template to compare data once the data reingest is possible. 
...
data_reingest <- readSchuur2009('~/Desktop/Research/data_reingests/Schuur')
      #this will not run due to missing information in the function
