...
Note the name of the author for the data reingest is Buell, but this comparison follows the data listed under USGS_S3C. 
...
data_reingest <- readBuell2011('~/Desktop/Research/data_reingests/Buell')
