...
tableInfo.ls <- list(reportA = list(
  ...
  chem_xray_vfine = list(title = 'Total chemical analyses of the fine (less than 47 micrometers) fraction by X-ray flourescence',
  ...
  chem_xray_fine = list(title = 'Total chemical analyses of the less-than-2-mm fraction by X-ray flourescence',
  ...
  chem_neurtron_vfine = list(title = 'Total chemical analyses of the fine (less than 47 μm) fraction by instrumental neutron activation',
  ...
  chem_neurtron_vfine2 = list(title = 'Total chemical analyses of the fine (less than 47 μm) fraction by instrumental neutron activation',
                              analysts = 'J. Budahn, R. Knight, D. McKown',
  ...
  chem_neurtron_fine = list(title = 'Total chemical analyses of the less-than-2mm fraction by instrumental neuorn activation',
  ...
  chem_neurtron_fine2 = list(title = 'Total chemical analyses of the less-than-2-mm fraction by instrumental neutron activation',
                             analysts = 'J. Baker, A. Bartel, D. Burgi, R. Johnson, R. Knight, H.T. Millard, V.G. Mossotti, S. Ramage, B. Scott, J. Taggart, J.S. Wahlberg, K. Wong',
                             columeNames = c('No', 'Sample', 'Horizon', 'Basal depth (cm)', 'Na', 'Nd', 'Rb', 'Sb', 'Sc', 'Sm', 'Sr', 'Ta', 'Tb', 'Th', 'Tm', 'U', 'Yb', 'Zr'),
                             note = 'Na values in weight percent; all others in parts per million.',
                             part1 = list(page = 71,
