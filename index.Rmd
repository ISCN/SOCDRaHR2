...
data_dir <- '~/Documents/Datasets/ISCN' #set to your directory to run this code
...
>>>>>>> 1ba3a469ed5faa2e70fa10cf92f97a20a5418e74
```
...
<<<<<<< HEAD
citation_raw <- read_delim('~/Desktop/Research/ISCN3/ISCN3_citation.csv', delim = ';', col_types = strrep('c', times = 12))
dataset_raw <- read_delim('~/Desktop/Research/ISCN3/ISCN3_dataset.csv', delim = ';', col_types = strrep('c', times = 19))
layer_raw <- vroom::vroom('~/Desktop/Research/ISCN3/ISCN3_layer.csv', col_types = strrep('c', times = 95))
profile_raw <-  vroom::vroom('~/Desktop/Research/ISCN3/ISCN3_profile.csv', col_types = strrep('c', times = 44))
=======
## ISCN3 structure
>>>>>>> 0c6c2afc05d48fc75d48b0ae1e30e1fea1eefa81

>>>>>>> 916b8ca0347ff4d0124d2a0c039a2ec57155b62c
