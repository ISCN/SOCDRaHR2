...
allCores.df <- plyr::ldply(allData.ls, .fun = function(xx) {
  ...
  if(xx$doi %in% c("10.1594/PANGAEA.929003", '10.1594/PANGAEA.929011', "10.1594/PANGAEA.929064")){
    names(xx$data) <- c('Depth sed [m] (Sample midpoint depth)', #keep the orginal name
                        'Cal age [ka BP] (OxCal 4.2.4)', 
                        'Cal age max [ka BP] (OxCal 4.2.4)', 'Cal age min [ka BP] (OxCal 4.2.4)',
                        'Cal age [ka BP] (Bacon 2.2)', 
                        'Cal age max [ka BP] (Bacon 2.2)', 'Cal age min [ka BP] (Bacon 2.2)') #add the methods that are dropped here
  }
