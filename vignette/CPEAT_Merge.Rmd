...
#write.table(PAGES_Geochemistry_data, file=file.path(folderpath,"PAGES_Geochemistry_CPEAT.txt"), row.names = FALSE, quote = FALSE, sep = "\t", na = "")



#Pull into a list, all the data from the files the specified dois in the search results 
allData.ls <- plyr::dlply(PAGES_Geochemistry, #search results
