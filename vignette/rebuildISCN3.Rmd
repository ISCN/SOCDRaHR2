...
The `Lu_PIMA` data set (@Ping2010) in ISCN3 contains 69 layer-level information and 2 profile-level information after cleaning for ISCN3.5.
This data set is located in the United States and has 69 layer level observations and 0 profile-level observations of 11 unique latitude-longitude locations in the layer-level table.
