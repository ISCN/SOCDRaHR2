...
This data set is located in the United States and has 172 layer-level observations and YYY profile-level observations of 172 unique latitude-longitude locations in the layer-level table and AAA in the profile-level table.
...
This data set is located in the United States and has 1510 layer-level observations and YYY profile-level observations of 143 unique latitude-longitude locations in the layer-level table and AAA in the profile-level table.
...
This data set is located in the United States and has 697 layer-level observations and YYY profile-level observations of 60 unique latitude-longitude locations in the layer-level table and AAA in the profile-level table.
...
This data set is located in the United States and has 139 layer-level observations and YYY profile-level observations of 31 unique latitude-longitude locations in the layer-level table and AAA in the profile-level table.
...
The USGS Harden dataset is references @Harden2008a, @ODonnell2011, @Manies204, @Harden2008b, @Harden2006 and @Neff2005.
This data set is located in the United States and has 1203 layer-level observations and 18 profile-level observations of 23 unique latitude-longitude locations in the layer-level table and 6 in the profile-level table.
...
This data set is located in the United States and has 28 layer-level observations and YYY profile-level observations of 14 unique latitude-longitude locations in the layer-level table and AAA in the profile-level table.
...
This data set is located in the United States and has 46 layer-level observations and 12 profile-level observations of 4 unique latitude-longitude locations in the layer-level table and 4 in the profile-level table.
...
This data set is located in the United States and has 231 layer-level observations and YYY profile-level observations of 1 unique latitude-longitude locations in the layer-level table and AAA in the profile-level table.
...
This data set is located in the United States and has 102 layer-level observations and YYY profile-level observations of 1 unique latitude-longitude locations in the layer-level table and AAA in the profile-level table.
...
This data set is located in the United States and has 1176 layer-level observations and YYY profile-level observations of 1 unique latitude-longitude locations in the layer-level table and AAA in the profile-level table.
