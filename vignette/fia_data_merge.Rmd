...
ISCN_layer.df <- ISCN3_3(data_dir = '~/Desktop/datasets/ISCN')
ISCN_layer.df <- as.data.frame(do.call(cbind, ISCN_layer.df[3]))

colnames(ISCN_layer.df) <- sub("layer.","", colnames(ISCN_layer.df))
