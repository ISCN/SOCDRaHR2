...
grouping_counties <- FIA_lab.df %>% 
  dplyr::select(CN, PLT_CN, INVYR, STATECD,COUNTYCD, BULK_DENSITY, C_ORG_PCT) %>% 
  dplyr::group_by(CN, STATECD) #%>% 
  #dplyr::summarise(grouping_counties, datapoints = n())
