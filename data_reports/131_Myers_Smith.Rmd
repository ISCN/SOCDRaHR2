...
dataset_study <- citation_raw %>% 
  ...
  standardCast() %>%
  replace_na(list(curator_name = 'Isla Myers-Smith', curator_organization = 'University of Edinburgh', curator_email = 'ftihm@uaf.edu', dataset_description = 'This data set contains soil data for cores from a transect from the center of the BBC collapse scar (0 m) into the surrounding burn (30 m). Thirty-five cores were collected soil cores along the transect in March 2003.'))
...
- note that there is actual data to be cited / reingested
