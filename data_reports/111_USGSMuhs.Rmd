...
In this section, we will pull out `USGS Muhs` from ISCN3 and clean it up. 
Empty columns were removed of the dataset were removed and missing values were filled in. This data set required a cryptic message in the profile of the dataset to be formally cited using BibTeX. (https://doi.org/10.1016/S0277-3791(03)00167-7)
...
dataset_profile_org <- profile_raw  %>%
   ...
   mutate(`site_note` = 'Muhs et al.(2003).Stratigraphy and palaeoclimatic significance of Late Quaternary loess-palaeosol sequences of the Last Interglacial-Glacial cycle in central Alaska.')%>%
   standardCast()
