...
The dataset Name data set in ISCN3 contains XX layer-level rows and YY profile-level information rows after cleaning for ISCN3.5.
...
ISCN3 <- ISCN3_1(data_dir, datasets_exclude = c("128_WorldwideSCND.Rmd", "129_NRSC_Sept2014.Rmd"))
...
## Layer Table
knitr::kable(summary(dataset_layer %>%
        filter(dataset_name == datasetName) %>% 
        select_if(is.factor)))
