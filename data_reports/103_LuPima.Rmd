...
#sort profile name to find duplicates
#check for duplicates and remove soc calculations, method, spatial flag (anything that starts with soc) then apply unique to get rid of duplicates

#dataset_layer <- layer_raw %>%
#  filter(dataset_name_sub == datasetName)
#sort layer name and see if there are any duplicates
#remove soc columns
