...
dataset_profile_org <- profile_raw  %>%
   ...
   standardCast() %>%
    ...
    `site_note` == 'See Bonanza Creek LTER online database for site EML' ~ 'Bonanza Creek LTER. (n.d.). Retrieved March 16, 2021, from https://www.lter.uaf.edu/data/data-catalog',
    TRUE ~ site_note)) 
