...
Changes needed to be done in ISCN 4.0 include referencing the site_note in the dataset_profile table and citing a database referenced in the dataset_study table.
