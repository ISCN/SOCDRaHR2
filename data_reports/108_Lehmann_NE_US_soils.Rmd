...
The Lehmann NE US soils data set in ISCN3 contains `r nrow(dataset_layer)` layer-level rows and `r nrow(dataset_layer)` profile-level information rows after cleaning for ISCN3.5.
