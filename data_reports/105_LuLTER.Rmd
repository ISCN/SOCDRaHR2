...
##reference rectangle
locs<-data.frame(long=c(210,214,214,210),lat=c(64,64,66,66))
...
Please see @Ping2005 for additional details and if you are using ISCN3 please cite.
