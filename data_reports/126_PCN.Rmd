...
The `Northern Circumpolar Soil Carbon Database (NCSCD)` data set in ISCN3 contains `r nrow(dataset_layer)` layer-level information and no profile-level information after cleaning for ISCN3.5.
