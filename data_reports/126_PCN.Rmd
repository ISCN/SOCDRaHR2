...
#add the lat-long to the layer information
dataset_layer <- dataset_layer %>%
  left_join(dataset_profile %>% select(site_name, profile_name, `lat (dec. deg)`, `long (dec. deg)`, `datum (datum)`),
            by = c('site_name', 'profile_name'))
```
