...
# clean up 
# look at the methods for the 31 columns/varibales 
# grouping the variables and look at thier methosd and find if they are interrelated or not 
# look at the uniwue methods for age methodologies 
# represent as a hybrid dataset? age-name, age-method, and age-unit column [how to standardize?]
...
oc_bd <- allCores.df %>%
          select(doi, `DBD [g/cm**3]`, `Corg dens [g/cm**3]`) %>% #, `TOC [%]`
